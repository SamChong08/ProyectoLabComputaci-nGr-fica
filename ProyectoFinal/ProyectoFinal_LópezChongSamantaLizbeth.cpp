...
// Camera
Camera  camera(glm::vec3(-240, 40, 120));	//CUARTO
//Camera  camera(glm::vec3(100, 70, 10));	//LA BUENA
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "LopezChongSamantaLizbeth_ProyectoFinal_Grupo09", nullptr, nullptr);
